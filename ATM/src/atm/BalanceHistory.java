...
public class BalanceHistory extends JFrame implements ActionListener {
    ...
    public BalanceHistory() {
        ...
        p1 = new JPanel(new GridLayout(2, 1,100,100));
            p1.setBackground(c);
